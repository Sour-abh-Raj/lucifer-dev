...
The recommended approach for using **lucifer-dev** is to first create your own site using the template with as few changes as possible, and only when it is up and running customize it however you like. This way it is easier to pinpoint what causes a potential issue in case of a bug. The minimum steps required to create your own site are:

1. Create a new repository using this template. For this, click on [Use this template -> Create a new repository](https://github.com/new?template_name=lucifer-dev&template_owner=Sour-abh-Raj) above the file list. If you plan to upload your site to `<your-github-username>.github.io`, note that the name of your repository MUST BE `<your-github-username>.github.io` or `<your-github-orgname>.github.io`, as stated in the [GitHub pages docs](https://docs.github.com/en/pages/getting-started-with-github-pages/about-github-pages#types-of-github-pages-sites).
...
5. Wait until the GitHub actions finish, then simply navigate to `https://<your-github-username>.github.io` in your browser. At this point you should see a copy of the theme's [demo website](https://Sour-abh-Raj.github.io/lucifer-dev/).
...
> Note: this approach is only necessary if you would like to build an older or very custom version of lucifer-dev.
...
For a hands-on walkthrough of running lucifer-dev locally without using Docker, check out [this cool blog post](https://george-gca.github.io/blog/2022/running-local-lucifer-dev/) by one of the community members!
...
To see the template running, open your browser and go to `http://localhost:4000`. You should see a copy of the theme's [demo website](https://Sour-abh-Raj.github.io/lucifer-dev/). Now, feel free to customize the theme however you like. After you are done, remember to **commit** your final changes.
...
Then from the website sources dir (commonly your lucifer-dev fork's clone):
...
In its default configuration, lucifer-dev will copy the top-level `README.md` to the publishing source. If you want to change this behavior, add `README.md` under `exclude` in `_config.yml`.

**Note:** Do _not_ run `jekyll clean` on your publishing source repo as this will result in the entire directory getting deleted, irrespective of the content of `keep_files` in `_config.yml`.

### Upgrading from a previous version

If you installed **lucifer-dev** as described above, you can configure a [GitHub action](https://github.com/AndreasAugustin/actions-template-sync) to automatically sync your repository with the latest version of the theme.
    ...
    steps:
      ...
      - name: actions-template-sync
        ...
        with:
          ...
          source_repo_path: Sour-abh-Raj/lucifer-dev
...
$ git remote add upstream https://github.com/Sour-abh-Raj/lucifer-dev.git
$ git fetch upstream
$ git rebase v0.11.0
```
